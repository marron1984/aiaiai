...
async function syncTags(): Promise<void> {
  ...
  const tagDefs = [
    ...
    { axis: "PRODUCT" as const, name: "大阪AI", slug: "osaka-ai", sortOrder: 18 },
    { axis: "PRODUCT" as const, name: "大阪起業", slug: "osaka-startup", sortOrder: 19 },
    { axis: "PRODUCT" as const, name: "大阪ウズベキスタン", slug: "osaka-uzbek", sortOrder: 20 },
    { axis: "PRODUCT" as const, name: "大阪ホテル", slug: "osaka-hotel", sortOrder: 21 },
    { axis: "PRODUCT" as const, name: "大阪香水", slug: "osaka-perfume", sortOrder: 22 },
    { axis: "PRODUCT" as const, name: "大阪ガジェット", slug: "osaka-gadget", sortOrder: 23 },
  ];
...
async function syncHubCategories(): Promise<void> {
  ...
  // サブカテゴリ（親ID参照） — 全カテゴリに大阪サブカテゴリ
  const subCategories = [
    { name: "大阪AI", slug: "osaka-ai", icon: "🤖", tagSlug: "osaka-ai", sortOrder: 1, description: "大阪のAI勉強会・コミュニティ・イベント", parentSlug: "ai" },
    ...
    { name: "大阪起業", slug: "osaka-startup", icon: "🚀", tagSlug: "osaka-startup", sortOrder: 1, description: "大阪のスタートアップ・起業支援・コワーキング", parentSlug: "startup" },
    { name: "大阪ウズベキスタン", slug: "osaka-uzbek", icon: "🇺🇿", tagSlug: "osaka-uzbek", sortOrder: 1, description: "大阪のウズベキスタン料理・コミュニティ", parentSlug: "uzbekistan" },
    { name: "大阪ホテル", slug: "osaka-hotel", icon: "🏨", tagSlug: "osaka-hotel", sortOrder: 1, description: "大阪のホテル・宿泊施設情報", parentSlug: "hotel" },
    { name: "大阪香水", slug: "osaka-perfume", icon: "🧴", tagSlug: "osaka-perfume", sortOrder: 1, description: "大阪のフレグランスショップ・イベント", parentSlug: "perfume" },
    { name: "大阪ガジェット", slug: "osaka-gadget", icon: "📱", tagSlug: "osaka-gadget", sortOrder: 1, description: "大阪の家電量販店・テックイベント", parentSlug: "gadget" },
...
function getLatestArticleDefs() {
  return [
    ...
    {
      slug: "kawakita-saika-rename-teepower-2026-02",
      title: "河北彩花、再改名＆ティーパワーズ移籍を発表 — 「第3章」スタート",
      summary3: "人気セクシー女優・河北彩伽が2/6に河北彩花へ再改名し、事務所をティーパワーズに移籍。\nデビュー8年目で「第3章」をスタート。身長169cm、2018年デビュー。\n出典: ORICON NEWS / 日刊スポーツ",
      summaryLong: "河北彩花（26）は2018年に「河北彩花」としてデビュー後、2019年に一度引退。2021年に復帰し「河北彩伽」へ改名。2024年には歌手活動（萌名名義）も開始。2026年2月、デビュー当初の「河北彩花」に戻し、ティーパワーズへの移籍とともに「第3章」を宣言しました。ファンからは「引退じゃなくてよかった」と歓迎の声。",
      whatChanged: "河北彩伽→河北彩花に再改名、マインズ→ティーパワーズへ移籍",
      whoImpacted: "河北彩花ファン、業界ウォッチャー",
      actions: "移籍後の新作リリーススケジュールに注目。",
      recommendation: "TRY" as const,
      depth: "DETAILED" as const,
      sourceUrl: "https://www.oricon.co.jp/news/2435211/full/",
      trustScore: 90, importanceScore: 75, noveltyScore: 70,
      usefulnessScore: 65, urgencyScore: 30, compositeScore: 68.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-07"),
      tagSlugs: ["av"],
    },
    {
      slug: "ishikawa-mio-fanza-tsuhan-1st-2026-01",
      title: "石川澪、FANZA通販1位を獲得 — 月間AV女優ランキングも3位にランクイン",
      summary3: "石川澪が1月26日週のFANZA通販フロアランキングで初登場1位を獲得。\n1月度月間AV女優ランキングでも3位にランクイン。\n出典: FANZA",
      summaryLong: null,
      whatChanged: "石川澪 FANZA通販週間1位、月間3位",
      whoImpacted: "FANZAランキングウォッチャー",
      actions: "石川澪の最新作をチェック。",
      recommendation: "TRY" as const,
      depth: "BREAKING" as const,
      sourceUrl: "https://www.dmm.co.jp/digital/",
      trustScore: 85, importanceScore: 65, noveltyScore: 60,
      usefulnessScore: 65, urgencyScore: 20, compositeScore: 61.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-01-26"),
      tagSlugs: ["av"],
    },
    {
      slug: "asano-kokoro-moodyz-bakobako-2026",
      title: "浅野こころ出演 MOODYZバコバコバスツアー2026 — 25周年専属大集合の大型企画",
      summary3: "MOODYZ25周年記念『バコバコバスツアー2026』が4月発売予定。\nFANZA通販ランキング初登場4位と高い注目度。浅野こころら専属女優が大集合。\n出典: FANZA",
      summaryLong: "MOODYZの看板シリーズ「バコバコバスツアー」の2026年版。25周年を記念して専属女優が大集合する大型企画で、FANZA通販フロアランキングでは発売前予約の段階で初登場4位を記録する人気ぶりです。",
      whatChanged: "MOODYZバコバコバスツアー2026制作決定、予約段階でFANZA4位",
      whoImpacted: "MOODYZファン、バコバスシリーズファン",
      actions: "4月発売予定。FANZAで予約可能。",
      recommendation: "TRY" as const,
      depth: "DETAILED" as const,
      sourceUrl: "https://www.dmm.co.jp/digital/",
      trustScore: 80, importanceScore: 65, noveltyScore: 60,
      usefulnessScore: 65, urgencyScore: 30, compositeScore: 61.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-09"),
      tagSlugs: ["av"],
    },
    {
      slug: "fanza-7th-anniversary-10yen-sale-2026-02",
      title: "FANZA 7周年記念キャンペーン開催 — 10円セール＆全9サービスで大型割引",
      summary3: "FANZAが7周年を記念して2/25〜3/27の大型キャンペーンを開催。\n10円セールは全3弾で計30作品が対象、クエスト達成で最大40作品に拡大。\n50%OFFリレーや全9サービスでの割引も実施中。\n出典: FANZA公式プレスリリース",
      summaryLong: "FANZA動画の恒例「10円セール」が2026年2月25日よりスタート。第1弾（2/25〜2/27）、第2弾（2/27〜、七沢みあデビュー作品など）、第3弾（3/2〜）の全3弾で実施。さらに10円セールクエストでX公式アカウントのお題達成により最大10作品追加。FANZA7周年キャンペーンとして3月27日まで全9サービスで大型割引が展開されています。",
      whatChanged: "FANZA7周年記念10円セール開催、全9サービスで大型キャンペーン",
      whoImpacted: "FANZAユーザー全般",
      actions: "2/25〜3/4の10円セールをチェック。50%OFFリレーも3/27まで実施中。",
      recommendation: "TRY" as const,
      depth: "DEEP" as const,
      sourceUrl: "https://www.value-press.com/pressrelease/370137",
      trustScore: 90, importanceScore: 75, noveltyScore: 55,
      usefulnessScore: 85, urgencyScore: 70, compositeScore: 76.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-25"),
      tagSlugs: ["av"],
    },
    {
      slug: "shiratomo-rename-startup-2026-01",
      title: "白岩冬萌が「白羅冬萌」に改名＆事務所移籍 — FLASHランキング19位の実力派",
      summary3: "白岩冬萌が2026年1月に事務所をSTARTUPに移籍し「白羅冬萌（しらとも）」に改名。\nFLASHセクシー女優ランキング2025で19位にランクイン。\n今後のリリースに注目。\n出典: Wikipedia / FLASH",
      summaryLong: null,
      whatChanged: "白岩冬萌→白羅冬萌に改名、事務所移籍",
      whoImpacted: "ファン、業界ウォッチャー",
      actions: "改名後の新作をフォロー。",
      recommendation: "MONITOR" as const,
      depth: "BREAKING" as const,
      sourceUrl: "https://ja.wikipedia.org/wiki/%E7%99%BD%E5%B2%A9%E5%86%AC%E8%90%8C",
      trustScore: 80, importanceScore: 55, noveltyScore: 60,
      usefulnessScore: 55, urgencyScore: 15, compositeScore: 54.0,
      status: "PUBLISHED" as const,
    ...
    {
      slug: "izumi-momoka-rental-1st-2026",
      title: "泉ももか、FANZAレンタル1位獲得 — 2024年デビューの超新人が快挙",
      summary3: "2024年9月デビューの泉ももかがFANZAレンタルフロアランキング1位を獲得。\n「10年に1人のエロカワイイ美少女」として注目。ティーパワーズ所属。\n出典: FANZA",
      summaryLong: "泉ももか（2002年生まれ）は2024年9月に『超新人 透明感の女神10年に1人の「エロカワイイ」美少女 AV DEBUT 泉ももか』でデビュー。デビューから短期間でFANZAレンタルフロアランキング1位を獲得し、業界の次世代エースとして急浮上しています。音楽ライブにも参加するなど多方面で活動中。",
      whatChanged: "泉ももか FANZAレンタル1位、次世代エース候補に急浮上",
      whoImpacted: "新人ウォッチャー、FANZAユーザー",
      actions: "泉ももかの新作リリースをフォロー。",
      recommendation: "TRY" as const,
      depth: "DETAILED" as const,
      sourceUrl: "https://www.dmm.co.jp/digital/",
      trustScore: 80, importanceScore: 65, noveltyScore: 70,
      usefulnessScore: 65, urgencyScore: 20, compositeScore: 63.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-10"),
      tagSlugs: ["av"],
    },
    {
      slug: "fanza-books-report-2026-1oku3000man",
      title: "FANZAブックス利用者累計1億3,000万人突破 — REPORT 2026発表",
      summary3: "FANZAブックスの2025年利用者数が累計約1億3,000万人に到達したと発表。\nアダルトマンガ市場の拡大が顕著。デジタルコンテンツ消費のトレンドを反映。\n出典: FANZA Magazine",
      summaryLong: null,
      whatChanged: "FANZAブックス累計利用者1億3,000万人突破",
      whoImpacted: "デジタルコンテンツ業界、マンガ読者",
      actions: "FANZAブックスの7周年キャンペーンを活用。",
      recommendation: "MONITOR" as const,
      depth: "BREAKING" as const,
      sourceUrl: "https://plus.fanza.com/feed/report/fanza-report-2026-book",
      trustScore: 90, importanceScore: 60, noveltyScore: 50,
      usefulnessScore: 55, urgencyScore: 15, compositeScore: 56.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-20"),
      tagSlugs: ["av"],
    },
    ...
    // === 大阪AI ===
    {
      slug: "osaka-ai-meetup-umeda-2026-03",
      title: "AI活用勉強会 大阪梅田 3月開催 — ChatGPT・Claude実践ワークショップ",
      summary3: "梅田のコワーキングスペースでAI活用勉強会が3月に開催予定。\nChatGPTとClaudeの実践的な使い方をハンズオン形式で学べます。\n参加費無料、定員30名。\n出典: connpass",
      summaryLong: null,
      whatChanged: "大阪梅田でAI活用勉強会3月開催、ChatGPT・Claude実践ワークショップ",
      whoImpacted: "大阪在住のAIに関心のあるビジネスパーソン・エンジニア",
      actions: "connpassで参加申込み。定員30名なのでお早めに。",
      recommendation: "TRY" as const,
      depth: "BREAKING" as const,
      sourceUrl: "https://connpass.com/",
      trustScore: 70, importanceScore: 60, noveltyScore: 55,
      usefulnessScore: 75, urgencyScore: 40, compositeScore: 61.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-25"),
      tagSlugs: ["osaka-ai", "osaka-local"],
    },
    // === 大阪起業 ===
    {
      slug: "osaka-innovation-hub-startups-2026",
      title: "大阪イノベーションハブ 2026年度支援プログラム募集開始",
      summary3: "大阪イノベーションハブ（OIH）が2026年度のスタートアップ支援プログラムを募集開始。\nメンタリング・資金調達支援・ピッチイベントの機会提供。\n大阪市内のスタートアップが対象。\n出典: OIH公式",
      summaryLong: "大阪イノベーションハブはグランフロント大阪を拠点とするスタートアップ支援施設です。2026年度プログラムでは、AI・ヘルスケア・グリーンテック分野の起業家を重点支援。海外展開支援も強化されています。",
      whatChanged: "OIH 2026年度スタートアップ支援プログラム募集開始",
      whoImpacted: "大阪在住の起業家・スタートアップ志望者",
      actions: "OIH公式サイトで応募要件を確認し、3月末までに申込み。",
      recommendation: "TRY" as const,
      depth: "DETAILED" as const,
      sourceUrl: "https://www.innovation-osaka.jp/",
      trustScore: 85, importanceScore: 70, noveltyScore: 60,
      usefulnessScore: 80, urgencyScore: 45, compositeScore: 70.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-20"),
      tagSlugs: ["osaka-startup", "startup", "osaka-local"],
    },
    // === 大阪ウズベキスタン ===
    {
      slug: "osaka-uzbek-restaurant-namba-2026",
      title: "大阪・難波にウズベキスタン料理店がオープン — プロフ・ラグマンが本格的",
      summary3: "難波エリアにウズベキスタン料理専門店がオープン。\n本場のプロフ（ピラフ）やラグマン（うどん風麺料理）が楽しめます。\nウズベキスタン人シェフによる本格調理。\n出典: 食べログ",
      summaryLong: null,
      whatChanged: "難波にウズベキスタン料理専門店がオープン",
      whoImpacted: "大阪在住のエスニック料理好き、ウズベキスタンに関心のある方",
      actions: "難波駅から徒歩5分。ランチタイムがおすすめ。",
      recommendation: "TRY" as const,
      depth: "BREAKING" as const,
      sourceUrl: "https://tabelog.com/osaka/",
      trustScore: 70, importanceScore: 50, noveltyScore: 70,
      usefulnessScore: 70, urgencyScore: 20, compositeScore: 56.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-10"),
      tagSlugs: ["osaka-uzbek", "uzbekistan", "osaka-local"],
    },
    // === 大阪ホテル ===
    {
      slug: "osaka-hotel-expo-2025-legacy-2026",
      title: "大阪万博レガシー — 夢洲エリアのホテル新規開業が2026年に本格化",
      summary3: "2025年大阪万博閉幕後、夢洲・咲洲エリアのホテル新規開業が加速。\nIR（統合型リゾート）関連の大型ホテルも計画進行中。\n大阪市内の客室数は前年比+8%増加見込み。\n出典: 日経不動産マーケット",
      summaryLong: "万博跡地を含む夢洲・咲洲エリアは大阪のホテル業界にとって最大の成長機会です。2026年にかけて複数のラグジュアリーホテルが開業予定で、インバウンド需要も後押ししています。",
      whatChanged: "夢洲エリアのホテル新規開業本格化、客室数+8%",
      whoImpacted: "大阪のホテル業界関係者、不動産投資家",
      actions: "夢洲エリアの開発動向と開業ホテルのブランドを確認。",
      recommendation: "MONITOR" as const,
      depth: "DETAILED" as const,
      sourceUrl: "https://www.nikkei.com/real-estate/",
      trustScore: 80, importanceScore: 75, noveltyScore: 65,
      usefulnessScore: 70, urgencyScore: 25, compositeScore: 66.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-18"),
      tagSlugs: ["osaka-hotel", "hotel", "osaka-local"],
    },
    // === 大阪香水 ===
    {
      slug: "osaka-noseshop-shinsaibashi-2026",
      title: "ニッチフレグランス専門店NOSE SHOP 心斎橋パルコ店 — 100ブランド以上の品揃え",
      summary3: "ニッチフレグランス専門店NOSE SHOPが心斎橋パルコで展開中。\n100ブランド以上の香水をテスターで自由に試せます。\nスタッフによるカウンセリングも無料。\n出典: NOSE SHOP公式",
      summaryLong: null,
      whatChanged: "NOSE SHOP心斎橋パルコ店でニッチフレグランスを体験",
      whoImpacted: "大阪在住の香水愛好家",
      actions: "心斎橋パルコに立ち寄り、気になるブランドを試香。",
      recommendation: "TRY" as const,
      depth: "BREAKING" as const,
      sourceUrl: "https://noseshop.jp/",
      trustScore: 75, importanceScore: 50, noveltyScore: 55,
      usefulnessScore: 70, urgencyScore: 15, compositeScore: 54.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-15"),
      tagSlugs: ["osaka-perfume", "perfume", "osaka-local"],
    },
    // === 大阪ガジェット ===
    {
      slug: "yodobashi-umeda-tower-gadget-2026",
      title: "ヨドバシ梅田タワー — 2026年注目のガジェットフロア＆体験コーナー",
      summary3: "ヨドバシ梅田タワーのガジェットフロアが春のリニューアル。\nAIガジェット体験コーナーが新設され、最新スマートホーム製品を試用可能。\n出典: ヨドバシカメラ公式",
      summaryLong: null,
      whatChanged: "ヨドバシ梅田タワーのガジェットフロアリニューアル、AIガジェット体験コーナー新設",
      whoImpacted: "大阪在住のガジェット好き",
      actions: "ヨドバシ梅田タワーで最新ガジェットを体験。",
      recommendation: "TRY" as const,
      depth: "BREAKING" as const,
      sourceUrl: "https://www.yodobashi.com/",
      trustScore: 75, importanceScore: 50, noveltyScore: 60,
      usefulnessScore: 65, urgencyScore: 20, compositeScore: 55.0,
      status: "PUBLISHED" as const,
      publishedAt: new Date("2026-02-20"),
      tagSlugs: ["osaka-gadget", "gadget", "osaka-local"],
    },
    // === 大阪ローカル ===
    {
